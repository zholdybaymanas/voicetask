...
const NAV = [
  {
    path: '/', end: true, label: 'Канбан',
    // Kanban columns icon
    icon: 'M3.75 4.5A.75.75 0 014.5 3.75h3a.75.75 0 01.75.75v15a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-15zm6.75 0a.75.75 0 01.75-.75h3a.75.75 0 01.75.75v9a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-9zm6.75 0a.75.75 0 01.75-.75h3a.75.75 0 01.75.75v6a.75.75 0 01-.75.75h-3a.75.75 0 01-.75-.75v-6z',
  },
  {
...
const PAGE_TITLES = {
  '/': 'Канбан', '/dashboard': 'Дашборд', '/tasks': 'Задачи',
  '/projects': 'Проекты', '/team': 'Команда', '/notifications': 'Уведомления',
}
